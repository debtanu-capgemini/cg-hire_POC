...
const interviewMode = [
  ...
  {
    value:
      "Personal (Person is sitting in any one of Capgemini India locations and you talk over phone)",
    label:
      "Personal (Person is sitting in any one of Capgemini India locations and you talk over phone)",
  },
  {
        ...
        <form onSubmit={formik.handleSubmit}>
          <Box sx={{ mt: 6, mb: 2 }}>
            ...
            <Typography
              variant="h7"
              component="div"
              className="feedback_subheader_1"
            >
              ...
              <Grid item md={4} xs={12}>
                <Card sx={{ maxWidth: 180, ml: 12, justifyContent: "center" }}>
                  ...
                  >
                    ...
                    {upperCase(`${editData.fname} ${editData.lName}`)}
                    </Typography>
                    <Typography color="textSecondary" className="avatarT2" >
                      {`${editData.address.city} ${editData.address.country}`}
                    </Typography>
                  </Box>
                </Card>
              </Grid>
            ...
            <Grid className="feedback_header_1" container spacing={3}>
              <Grid item md={8} xs={12}>
                ...
                >
                  <InputLabel>
                    {" "}
                    Mode of Interview <span className="required">*</span>
                  </InputLabel>
                  <Select
                    error={Boolean(
                      formik.touched.ModeOfInterview &&
                        formik.errors.ModeOfInterview
                    )}
                    helperText={
                      formik.touched.ModeOfInterview &&
                      formik.errors.ModeOfInterview
          ...
          <Box>
            ...
            <Grid className="feedback_header_1" container spacing={3}>
              <Grid item md={3} xs={12}>
                ...
                <Typography align="left" className="subHeadingRating">
              ...
              <Grid item md={3} xs={12}>
                ...
                <Typography align="left" className="subHeadingRating">
                  (With special reference to function for which he/she is being
                  interviewed)
                </Typography>
              </Grid>
              <Grid item md={3} xs={12} sx={{ mt: 1 }}>
              ...
              <Grid item md={3} xs={12}>
                ...
                <Typography align="left" className="subHeadingRating">
                  (Knowledge of languages, software development processes,
                  testing / debugging practices. Using the knowledge to solve
                  technical issues in projects )
                </Typography>
              </Grid>
          ...
          <Box>
            ...
            <Grid className="feedback_header_1" container spacing={3}>
              <Grid item md={3} xs={12}>
                ...
                <Typography align="left" className="subHeadingRating">
                  (Ability to propose & start new things on his / her own
              ...
              <Grid item md={3} xs={12}>
                ...
                <Typography align="left" className="subHeadingRating">
                  (Verbal, Non Verbal and Written ability to articulate ones
                  thoughts)
                </Typography>
              </Grid>
              ...
              <Grid item md={3} xs={12}>
                ...
                <Typography align="left" className="subHeadingRating">
                  (Willingness to work in Shifts,Relocation -Onsite/Local)
                </Typography>
              </Grid>
              <Grid item md={3} xs={12} sx={{ mt: 1 }}>
                <FormControl
              ...
              <Grid item md={3} xs={12} sx={{ mt: 3 }}>
                <Typography
                  ...
                  className="feedbackFieldHeader"
                >
                  Candidate requires training on
                </Typography>
              </Grid>
              <Grid item md={3} xs={12}>
                <TextField
          ...
          <Box>
            ...
            <Grid className="feedback_header_1" container spacing={1}>
              <Grid item md={4} xs={12} sx={{ mt: 2 }}>
                ...
                >
                  <InputLabel>
                    Overall Rating Scale <span className="required">*</span>
                  </InputLabel>
                  <Select
                    error={Boolean(
                      formik.touched.ratingScale && formik.errors.ratingScale
                    )}
                    helperText={
                      formik.touched.ratingScale && formik.errors.ratingScale
                    }
