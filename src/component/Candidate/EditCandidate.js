...
import ApplicantFeedbackFormCopy from "./ApplicantFeedbackFormCopy";
...
export default function EditCandidate() {
  ...
  function candidateForm(activeStep) {
    if (activeStep === 0 && editData) {
      return <ApplicantEditForm edit={editData} Candid={id} />;
    }
    if (activeStep === 1 && editData) {
      // alert("1");
      return <FeedbackForm editData={editData} Candid={id} />;
    }
    if (activeStep === 2 && editData) {
      // return <ApplicantFinalProcess edit={editData} Candid={id} />;
      return <ApplicantFinalProcess edit={editData} Candid={id} />;
    }
  }
